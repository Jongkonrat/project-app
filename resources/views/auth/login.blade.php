...
<section class="ftco-section">
    ...
    <form method="post" action="{{ route('login.perform') }}">
        ...
        <div class="form-group form-floating mb-3">
            <label class="label" for="floatingName">Email or Username</label>
            <input class="form-control" type ="text" name="username" value="{{ old('username') }}" placeholder="Username" required="required" autofocus>
