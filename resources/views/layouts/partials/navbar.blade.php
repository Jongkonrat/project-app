<header class="p-3 bg-dark text-white">
    <div class="container d-flex flex-wrap">
        ...
        <div class="d-flex flex-wrap align-items-center justify-content-end" style="align-items: flex-end; width: fit-content;margin-left: auto;">
            ...
            background-color: rgb(255, 169, 15); margin-right: 12px;">Cart</a>

            <a href="{{ url('profile') }}" style="border-radius: 5px; padding: 7px; padding-left: 16px; padding-right: 16px;
            background-color: white; margin-right: 12px;">Profile</a>
